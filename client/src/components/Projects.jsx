...
const dummyImages = [
  "https://picsum.photos/seed/serenity/600/400",
  "https://picsum.photos/seed/project2/600/400",
  "https://picsum.photos/seed/project3/600/400"
];

const extraProjects = [
  { title: "TaskFlow", subtitle: "Personal Productivity Dashboard", description: "A sample productivity dashboard concept with drag-and-drop task boards.", tech: ["React.js", "Tailwind CSS", "LocalStorage"], link: "", repo: "" },
  { title: "WeatherNow", subtitle: "Weather Forecast App", description: "A sample weather app concept that fetches live forecast data.", tech: ["React.js", "REST API", "CSS"], link: "", repo: "" }
];
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {allProjects.map((project, i) => (
            <motion.div key={project.title} initial={{ opacity: 0, y: 40 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.3 }} transition={{ duration: 0.5, delay: i * 0.15 }} whileHover={{ y: -8 }} className="bg-white dark:bg-gray-950 border border-gray-200 dark:border-gray-800 rounded-2xl overflow-hidden hover:border-blue-600 transition-colors">
              <img src={dummyImages[i % dummyImages.length]} alt={project.title} className="w-full h-44 object-cover" />
              <div className="p-6">
